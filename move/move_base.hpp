...
namespace kinematics {
  ...
  public:
     ...
     * @param angular_z [rad/s]
     */
    void move(value_type vx, value_type vy, value_type angular_z) { move(vx, vy, angular_z); }
    /**
     * @brief 停止動作
     *
     */
     ...
     */
    std::vector<value_type> get_wheel_speeds() const { return wheel_speeds; }

  protected:
    std::vector<value_type> wheel_speeds; // [rps]
    // robot parameter
